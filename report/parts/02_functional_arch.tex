...
Ѕыло решено сделать удобные обертки над функци€ми библиотеки \emph{openssl}~\cite{openssl}. Ѕыли реализованы следующие функции:
\begin{enumerate}
\item \t{md5\_hash} Ч функци€, вычисл€юща€ \emph{md5}-хеш строки~\cite{md5};
